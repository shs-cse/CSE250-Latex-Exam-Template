...
\def\O{\ohm} % for use in circuitikz
\DeclareSIUnit{\O}{\ohm}
            ...
            \parbox{0.95\textwidth}{%
                \begin{itemize}[\checkmark,nosep,leftmargin=16pt]
                    ...
                    \item Bonus questions are indicated as ``\textbf{\textit{(bonus)}}" along with allotted marks.
                          \fi
                    \item Write your answers inside the indicated boxes (where applicable). In case you run out of room for an answer, please continue on the back of the page.
